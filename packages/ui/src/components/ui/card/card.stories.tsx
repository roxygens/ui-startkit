...
const DefaultCardHeader = (
  <Card.Header>
    <div className="flex items-center gap-2 mb-[8px] pl-[16px]">
      <svg
        width="16"
        height="17"
        viewBox="0 0 16 17"
    ...
    <Card.HeaderImages
      ...
      className="ml-[16px] mb-[20px]"
    />

    <div className="flex flex-row items-start gap-[8px] mb-[4px] pl-[16px]">
    ...
    <p className="font-inter font-medium text-xs leading-[18px] text-[#707179] mb-[16px] pl-[16px]">
...
const DefaultCardContent = (
  <Card.Content className="pr-[28px] pl-[16px]">
    ...
    <p className="font-inter font-medium text-sm leading-5 text-[#707179]">
...
const DefaultCardFooterWithOptions = (
...
const DefaultCardWithOptions = (
  <>
    {DefaultCardHeader}
    {DefaultCardContent}
    {DefaultCardFooterWithOptions}
  </>
)

const RemoveCardFooter = (
  <Card.FooterButton
  ...
  >
    <div className="flex items-center gap-2 text-white">
      ...
      >
        <path
          d="M11.1667 4.00016V3.46683C11.1667 2.72009 11.1667 2.34672 11.0213 2.06151C10.8935 1.81063 10.6895 1.60665 10.4387 1.47882C10.1534 1.3335 9.78007 1.3335 9.03333 1.3335H7.96667C7.21993 1.3335 6.84656 1.3335 6.56135 1.47882C6.31046 1.60665 6.10649 1.81063 5.97866 2.06151C5.83333 2.34672 5.83333 2.72009 5.83333 3.46683V4.00016M2.5 4.00016H14.5M13.1667 4.00016V11.4668C13.1667 12.5869 13.1667 13.147 12.9487 13.5748C12.7569 13.9511 12.451 14.2571 12.0746 14.4488C11.6468 14.6668 11.0868 14.6668 9.96667 14.6668H7.03333C5.91323 14.6668 5.35318 14.6668 4.92535 14.4488C4.54903 14.2571 4.24307 13.9511 4.05132 13.5748C3.83333 13.147 3.83333 12.5869 3.83333 11.4668V4.00016"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const RemoveCardFooterWithOptions = (
  <Card.FooterButton
    onClick={() => console.log('Adicionar ao carrinho')}
    options={options}
    className="bg-destructive text-white"
...
const RemoveCardWithOptions = (
  <>
    {DefaultCardHeader}
    {DefaultCardContent}
    {RemoveCardFooterWithOptions}
  </>
)
...
const MiniCardContent = (
  <Card.Content>
    <h1 className="text-center text-white font-inter not-italic font-medium text-[10.304px] leading-[15px] mt-[12px]">
      Vice
    </h1>

    <div className="flex justify-center items-center gap-[4px]">
      <p className="text-[var(--muted-foreground)] not-italic font-normal text-[11.81px] leading-[17.71px] tracking-[0] text-center">
        De
      </p>
      <span className=" text-white font-bold text-[14.76px] leading-[22.14px] tracking-normal text-center">
        R$ {formatCurrency(6663.9)}
      </span>
    </div>
  </Card.Content>
...
const MiniCardFooterWithOptions = (
  <Card.FooterButton
    className="rounded-b-[4px]"
    onClick={() => console.log('Adicionar ao carrinho')}
    options={options}
...
const MiniCardWithOptions = (
  <>
    {MiniCardHeader}
    {MiniCardContent}
    {MiniCardFooterWithOptions}
  </>
)
...
export const DefaultWithOptions: Story = {
  args: {
    children: DefaultCardWithOptions,
    onClick() {
      console.log('Clicked - Card')
    },
  },
...
export const RemoveWithOptions: Story = {
  args: {
    children: RemoveCardWithOptions,
    onClick() {
      console.log('Clicked - Card')
    },
  },
...
export const Mini: Story = {
  args: {
    children: MiniCard,
    className:
      'px-[16px] pt-[32px] rounded-[4px] rounded-tl-none rounded-tr-none border-t-[3px] border-t-[var(--primary)] hover:border-0 hover:border-t-[3px] hover:border-t-[var(--primary)]',
    onClick() {
      console.log('Clicked - Card')
    },
  },
...
export const MiniWithOptions: Story = {
  args: {
    children: MiniCardWithOptions,
    className:
      'px-[16px] pt-[32px] rounded-[4px] rounded-tl-none rounded-tr-none border-t-[3px] border-t-[var(--primary)] hover:border-0 hover:border-t-[3px] hover:border-t-[var(--primary)]',
    onClick() {
      console.log('Clicked - Card')
