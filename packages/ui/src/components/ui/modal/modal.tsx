  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className={className}>
        <div className="absolute sm:left-[5rem] py-[1.5rem] pl-[1rem] text-white text-md sm:text-xl leading-[120%] font-semibold border-b-1 border-[var(--table-border)] w-[calc(100%-10rem)]">
          {title}
        </div>
