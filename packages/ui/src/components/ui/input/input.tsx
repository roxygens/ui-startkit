...
const inputVariants = cva(
  `
    ...
    file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm disabled:bg-[var(--primary-disabled)] disabled:text-[var(--primary-foreground-disabled)]
