  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-[15px] text-[var(--muted-foreground)]   group-hover:text-[var(--primary)] " />
...
type SelectInputProps = React.ComponentProps<typeof SelectPrimitive.Trigger> & VariantProps<typeof selectVariants> &   OtherProps
