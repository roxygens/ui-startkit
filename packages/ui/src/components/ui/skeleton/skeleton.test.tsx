...
describe('Skeleton', () => {
  ...
  it('should have default classes', () => {
    const { getByTestId } = render(<Skeleton data-testid="skeleton" />)
    expect(getByTestId('skeleton')).toHaveClass('bg-neutral-gray', 'animate-pulse')
  })

  it('should merge custom className with default classes', () => {
    const { getByTestId } = render(<Skeleton data-testid="skeleton" className="custom-class" />)
    expect(getByTestId('skeleton')).toHaveClass('bg-neutral-gray', 'animate-pulse', 'custom-class')
  })
